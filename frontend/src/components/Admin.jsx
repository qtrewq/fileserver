...
import api from '../api';
import { ArrowLeft, UserPlus, Trash2, Shield, User, Key, Edit2, Check, X, Users, FolderPlus, Settings } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen p-4 md:p-8 w-full mx-auto pb-20 md:pb-8">
            <div className="flex items-center justify-between mb-6 md:mb-8">
                ...
                {/* Tabs */}
                <div className="glass-card p-1 flex items-center gap-1 rounded-lg">
                    <button
                        onClick={() => setActiveTab('users')}
                        className={`px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium transition-all ${activeTab === 'users'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium transition-all ${activeTab === 'server'
